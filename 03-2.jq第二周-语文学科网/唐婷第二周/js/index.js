...
$(".kai").click(function(){
    ...
    $(".onn").eq($(this).index()).show().siblings().hide();
    $(".remen_ul").eq($(this).index()).show().siblings().hide();
})

// 学生天地
$(".lun a").click(function(){
    $(this).addClass("onnnn").siblings().removeClass("onnnn");
    $(".luntan_b ul").eq($(this).index()).show().siblings().hide();
})